...
public class TransactionControllerGetTransactionTests {
    ...
    @Test
    public void noUserGetTransactionShouldReturnForbidden() throws Exception {
        this.mockMvc.perform(get("/api/v3/transaction"))
                .andDo(print())
                .andExpect(status()
                .isForbidden())
    ...
    @Test
    public void withUserGetTransactionShouldReturnDefaultListForEmpty() throws Exception {
        transactionIdFailureExpect("");
    }

    @Test
    public void withUserGetTransactionShouldReturnDefaultListForEmptyJson() throws Exception {
        transactionIdFailureExpect("{}");
    }

    @Test
    public void withUserGetTransactionShouldReturnErrorForInvalidTransaction() throws Exception {
    ...
    @Test
    public void withUserGetTransactionShouldReturnErrorForNotFoundTransaction() throws Exception {
        Map<String, Object> temp = new HashMap<String, Object>(){{
            put("transactionId", "transaction");
        }};
        this.mockMvc.perform(post("/api/v3/transaction")
    ...
    @Test
    public void withUserGetTransactionShouldReturnInfo() throws Exception {
        Map<String, Object> temp = new HashMap<String, Object>(){{
        ...
        this.mockMvc.perform(post("/api/v3/transaction")
                ...
                .andExpect(jsonPath("$.fx.merchant").isMap())
                .andExpect(jsonPath("$.customerInfo").isMap())
                .andExpect(jsonPath("$.acquirer").isMap())
                .andExpect(jsonPath("$.merchant").isMap())
                .andExpect(jsonPath("$.transaction").isMap())
                .andExpect(jsonPath("$.transaction.merchant").isMap())
                .andExpect(jsonPath("$.transaction.merchant.transactionId").value("transaction_10"))
                .andExpect(jsonPath("$.transaction.merchant.agentInfo").isMap());
    }
